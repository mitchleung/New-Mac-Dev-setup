...
# - **thaw** - macOS menu bar utility that helps hide and organize excessive menu bar icons for a cleaner look.
...
# - **prepros** - preprocessor tool for compiling and optimizing web development assets like SCSS/SASS/LESS.
